...
I am a Postdoctoral Fellow at [Hong Kong University of Science and Technology (HKUST)](https://www.ust.hk/), advised by Prof. [Wei Wang](https://www.cse.ust.hk/~weiwa/), and a Researcher at [Alibaba Group](https://www.alibaba.com/), working on AI infrastructure and distributed systems for large language models and world models. I received my Ph.D. from [Nanyang Technological University (NTU)](https://www.ntu.edu.sg/), supervised by Prof. [Yonggang Wen](https://personal.ntu.edu.sg/ygwen/) and co-supervised by Prof. [Tianwei Zhang](https://tianwei-zhang.github.io/). I received my B.Eng. from [Beihang University](https://www.buaa.edu.cn/) in 2019.
...
I am a core contributor to [**ROLL**](https://github.com/alibaba/ROLL), an open-source reinforcement learning post-training framework (3K+ GitHub stars).

**Research Interests:**

![RL Post-Training](https://img.shields.io/badge/RL%20Post--Training-2C3E50?style=flat-square)
![Agent Infrastructure](https://img.shields.io/badge/Agent%20Infrastructure-2C3E50?style=flat-square)
![World Model Training](https://img.shields.io/badge/World%20Model%20Training-2C3E50?style=flat-square)
![MLSys](https://img.shields.io/badge/MLSys-2C3E50?style=flat-square)
![LLM Training](https://img.shields.io/badge/LLM%20Training-2C3E50?style=flat-square)
![Cluster Scheduling](https://img.shields.io/badge/Cluster%20Scheduling-2C3E50?style=flat-square)

📧 Email: [csgaowei@ust.hk](mailto:csgaowei@ust.hk) &nbsp;|&nbsp; [Google Scholar](https://scholar.google.com/citations?user=lmtOFm4AAAAJ&hl=en) &nbsp;|&nbsp; [GitHub](https://github.com/gaow0007)
